...
void al07(){
  ...
  gausfit->SetParameter(0,901);
  gausfit->SetParameter(1,72);
  gausfit->SetParLimits(1,70,75);
  gausfit->SetParameter(2,1);

  gausfit->SetParameter(3,908);
  gausfit->SetParameter(4,77);
  gausfit->SetParameter(5,1);

  gausfit->SetParameter(6,897);
  gausfit->SetParameter(7,82);
  gausfit->SetParLimits(7,80,83);
  gausfit->SetParameter(8,1);

  gausfit->SetParameter(9,890);
